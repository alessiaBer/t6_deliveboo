    ...
    <form action="{{ route('admin.restaurants.store') }}" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="address" id="address" class="form-control @error('address') is-invalid @enderror"
                value="{{ old('address') }}" placeholder="Restaurant address">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="p_iva" id="p_iva" class="form-control @error('p_iva') is-invalid @enderror"
                value="{{ old('p_iva') }}" placeholder="Restaurant p_iva">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="phone" id="phone" class="form-control @error('phone') is-invalid @enderror"
                value="{{ old('phone') }}" placeholder="Restaurant phone">
        ...
        <div class="mb-3">
            ...
            <input type="date" name="created_at" id="created_at"
                class="form-control @error('created_at') is-invalid @enderror" value="{{ old('created_at') }}"
        ...
        <div class="mb-3">
            ...
            <input type="text" name="image_url" id="image_url"
                class="form-control @error('image_url') is-invalid @enderror" placeholder="Restaurant image_url">
        ...
        <button type="submit" class="btn btn-primary">Insert restaurant</button>
